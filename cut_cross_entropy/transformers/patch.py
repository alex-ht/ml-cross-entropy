...
PATCH_FNS = {
    ...
    "cohere2_moe": ("cut_cross_entropy.transformers.cohere2_moe", "patch_cohere2_moe"),
    "cohere2_vision": ("cut_cross_entropy.transformers.cohere2_vision", "patch_cohere2_vision"),
    "cohere_compass": ("cut_cross_entropy.transformers.cohere_compass", "patch_cohere_compass"),
    "cohere_compass_text": (
        "cut_cross_entropy.transformers.cohere_compass",
        "patch_cohere_compass_text",
    ),
    ...
    "exaone4_5": ("cut_cross_entropy.transformers.exaone4_5", "patch_exaone4_5"),
    ...
    "qwen3_5_text": ("cut_cross_entropy.transformers.qwen3_5", "patch_qwen3_5_text"),
    "qwen3_5_moe": ("cut_cross_entropy.transformers.qwen3_5_moe", "patch_qwen3_5_moe"),
    "qwen3_5_moe_text": ("cut_cross_entropy.transformers.qwen3_5_moe", "patch_qwen3_5_moe_text"),
